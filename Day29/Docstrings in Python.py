...
def karanintro(age, a, b):
    '''This function introduces Karan Bainade with the provided details.'''
    return f"Hello, I am {a} {b}. I am {age} years old and I am from Aurangabad, Maharashtra. I recently completed my graduation from Hi-Tech Institute of Technology."

print(karanintro(22, 'Karan', 'Bainade'))
