...
lists are mutable. This means you can modify a list after it has been created, such as adding, removing, or changing elements.
...
marks =   [35, 67, 98, 34,"karan",53,90,99,24]
#index no. 0   1   2   3    4       5  6  7  8  
#index neg-9  -8  -7  -6   -5      -4 -3 -2  -1
